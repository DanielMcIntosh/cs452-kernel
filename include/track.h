...
const track_edge *next_edge_on_route(const Route *route, int * restrict ind, const track_node *n, bool* on_route, const char * restrict sig);

const track_node *next_sensor_on_route(const Route *route, int * restrict idx, const track_node *prev, int * restrict distance,  bool* on_route, const char * restrict sig);
const track_node *next_switch_on_route(const Route *route, int * restrict idx, const track_node *prev, int * restrict distance,  bool* on_route, const char * restrict sig);
